...
func plugin_get_fields() *C.char {
	flds := []sinsp.FieldEntry{
		...
		{Type: "string", ID: FieldIDCtTime, Name: "ct.time", Display: "Timestamp", Desc: "the timestamp of the cloudtrail event (eventTime in the json).", Visibility: "hidden"},
		...
		{Type: "uint64", ID: FieldIDS3CntPut, Name: "s3.cnt.put", Display: "N Put Ops", Desc: "the number of put operations. This field is 1 for PutObject events, 0 otherwise.", Visibility: "hidden"},
		{Type: "uint64", ID: FieldIDS3CntOther, Name: "s3.cnt.other", Display: "N Other Ops", Desc: "the number of non I/O operations. This field is 0 for GetObject and PutObject events, 1 for all the other events.", Visibility: "hidden"},
